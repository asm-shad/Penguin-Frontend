// components/modules/Admin/AdminManagement/AdminFormDialog.tsx
"use client";
...
import { createAdmin, updateAdmin } from "@/services/superAdmin/user.actions";
...
const AdminFormDialog = ({
  ...
  const [imagePreview, setImagePreview] = useState<string | null>(admin?.profileImageUrl || null);
              ...
              {imagePreview && (
                <div className="mb-2">
                  <p className="text-sm text-gray-600 mb-1">
                    {isEdit && admin?.profileImageUrl ? "Current Photo" : "New Photo"}:
                  </p>
                  <Image
                    src={imagePreview}
                    alt="Profile Preview"
