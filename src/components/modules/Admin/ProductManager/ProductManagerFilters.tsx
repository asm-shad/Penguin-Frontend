// components/modules/Admin/ProductManagerManagement/ProductManagerFilters.tsx
"use client";
...
const ProductManagerFilters = () => {
  return (
    <div className="space-y-3">
      {/* Row 1: Search and Refresh */}
      <div className="flex items-center gap-3">
        <SearchFilter paramName="searchTerm" placeholder="Search product managers..." />
        <RefreshButton />
      </div>
...
export default ProductManagerFilters;