...
import { createCategory } from "@/services/admin/catalogManagement.actions";
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        ...
        <form ref={formRef} action={formAction} className="space-y-4">
          ...
          <Field>
            <FieldLabel htmlFor="file">Category Image</FieldLabel>
            <Input
              ref={fileInputRef}
          ...
          <Field className="flex items-center justify-between">
            <FieldLabel htmlFor="isFeatured">Featured Category</FieldLabel>
            <Switch
              id="isFeatured"
              checked={isFeatured}
